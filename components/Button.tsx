...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-white border border-emerald-200 text-emerald-700 hover:bg-emerald-50 focus:ring-emerald-500",
    danger: "bg-red-500 hover:bg-red-600 text-white focus:ring-red-500",
    ghost: "text-emerald-600 hover:bg-emerald-100 focus:ring-emerald-500"
  };
